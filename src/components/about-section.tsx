          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              {timeline.map((item, index) => (
                <Card key={index} className="bg-card border-primary/20 animate-in fade-in slide-in-from-bottom-12 duration-500 transition-all hover:border-primary hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-2" style={{animationDelay: `${index * 150 + 400}ms`}}>
